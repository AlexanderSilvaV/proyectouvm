...
# administrador ve tabla de usuario
@login_required(login_url='adminlogin')
...
# administrador ve el o los productos
@login_required(login_url='adminlogin')
...
# administrador agrega productos una vez iniciada la sesion
@login_required(login_url='adminlogin')
...
# mostrar el estado de la compra en pedido confirmado, preparando, en entrega ....
@login_required(login_url='adminlogin')
